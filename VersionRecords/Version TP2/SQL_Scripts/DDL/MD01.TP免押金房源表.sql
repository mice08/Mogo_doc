...
CREATE TABLE `flat_power_freeforegift` (
  ...
  `beginTime` datetime NOT NULL COMMENT '开始时间(如:2017-04-01 00:00:00,与endTime同时使用,闭区间)',
  `endTime` datetime NOT NULL DEFAULT '2099-01-01 00:00:00' COMMENT '结束时间(如：2099-01-01 00:00:00,与beginTime同时使用,开区间)',
