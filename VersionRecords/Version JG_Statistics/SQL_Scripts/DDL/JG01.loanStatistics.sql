...
CREATE TABLE repo_loan_statistics_repay (
  ...
  statDate INT(8) NOT NULL COMMENT '统计日期(YYYYMMDD/YYYYMM)',
  dateUnit INT(3) NOT NULL COMMENT '日期单位(1:按天 2:按月)',
  shouldPayCount INT(8) NOT NULL DEFAULT '0' COMMENT '应还款日为当天的账单个数',
  paidCount INT(8) NOT NULL DEFAULT '0' COMMENT '应还款日为当天的账单中，状态为已还款的账单个数（之前或者当天还款）',
  unPayCount INT(8) NOT NULL DEFAULT '0' COMMENT '未还款账单数(应还款账单数-已还款账单数)',
  overdueCount INT(8) NOT NULL DEFAULT '0' COMMENT '截止至当日，仍旧处于逾期状态的还款账单',
  shouldPayAmount  DECIMAL(14,2) NOT NULL DEFAULT '0.00' COMMENT '应还款日为当天的账单总金额',
  paidAmount  DECIMAL(14,2) NOT NULL DEFAULT '0.00' COMMENT '应还款日为当天的账单中，已还款账单的总金额',
  unPayAmount  DECIMAL(14,2) NOT NULL DEFAULT '0.00' COMMENT '应还款日为当天的账单中，未还款账单的总金额',
  overdueAmount  DECIMAL(14,2) NOT NULL DEFAULT '0.00' COMMENT '截止至当日，仍旧处于逾期状态的还款账单的总额',
