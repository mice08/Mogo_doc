...
/*删除角色和消息类别关系*/
delete from mesg_category_role;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='公司合伙人' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='公司会计' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='公司出纳' and channel=45;
...
INSERT INTO `perm_menugroup_role_rel` (`roleId`,`menuGroupId`,`status`,`soDoneCode`,`createTime`,`updateTime`) VALUES (@roleId,44,1,0,now(),NULL);
/*插入角色和功能树关系*/
INSERT INTO `perm_menugroup_role_rel` (`roleId`,`menuGroupId`,`status`,`soDoneCode`,`createTime`,`updateTime`) VALUES (@roleId,165,1,0,now(),NULL);
/*插入角色和功能树关系*/
INSERT INTO `perm_menugroup_role_rel` (`roleId`,`menuGroupId`,`status`,`soDoneCode`,`createTime`,`updateTime`) VALUES (@roleId,186,1,0,now(),NULL);
/*插入角色和功能树关系*/
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='执行经理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='总部销售管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='总部业主管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='总部售后管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='总部房源管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店长' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店合伙人' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店会计' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店出纳' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店销售管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店房源管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店业主管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店售后管理' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='总部查看房态图' and channel=45;
...
/*根据角色名称查询id*/
select @roleId:=id from perm_role where roleName='分店查看房态图' and channel=45;
