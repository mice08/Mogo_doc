...
CREATE TABLE IF NOT EXISTS `flat_roomPrice` (
  ...
  INDEX `idx_startTime` (`startTime` ASC)
  ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '房间价格表';


-- -----------------------------------------------------
-- Table `flat_roomPriceDtl`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `flat_roomPriceDtl` (
  ...
  PRIMARY KEY (`id`),
  INDEX `idx_roomPriceId` (`priceId` ASC)
  ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '房间价格包';


-- -----------------------------------------------------
-- Table `flat_roomPriceBizType`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `flat_roomPriceBizType` (
  ...
  PRIMARY KEY (`id`)
  ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '房间价格业务类型';
...
-- -----------------------------------------------------
-- Table `flat_roomPriceBase`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `flat_roomPriceBase` ;

CREATE TABLE IF NOT EXISTS `flat_roomPriceBase` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `idx_goodsId_goodsIdType` (`goodsId` ASC, `goodsIdType` ASC),
  INDEX `idx_startTime` (`startTime` ASC)
  ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '房间基准价格表';
