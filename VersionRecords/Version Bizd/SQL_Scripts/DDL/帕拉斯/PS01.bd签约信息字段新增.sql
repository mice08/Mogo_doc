...
ALTER TABLE bizd_landlord_sign
  ...
  ADD COLUMN bankProvinceId varchar(16) DEFAULT NULL COMMENT '省',
  ADD COLUMN bankCityId varchar(16) DEFAULT NULL COMMENT '城市',
  ...
  ADD COLUMN officialWebSex VARCHAR(1) DEFAULT NULL COMMENT '官网联系人性别 ( 0 女 1 男)';