...
/*贷款合同表  新增关联贷款id*/
ALTER TABLE  loan_contract ADD COLUMN relContractId INT(11) NULL COMMENT '关联贷款id' AFTER prodType;

/*房东买回 新增贷款来源*/
ALTER TABLE  loan_landlord_buyback ADD COLUMN loanChannel INT(11) NOT NULL COMMENT '贷款来源,参考字典表loan_channel(1:拉卡拉 2:蘑菇 3:聚有财)' AFTER `status`;
/*房东买回 新增租客逾期滞纳金*/
