...
/*房东贷款申请 新增提前还账单天数*/
ALTER  TABLE loan_landlord_contract ADD COLUMN beforeDays INT (11) DEFAULT 15 NULL  COMMENT '提前还账单天数' AFTER canLoan;

/*房东贷款申请his 新增提前还账单天数*/
ALTER TABLE loan_landlord_contract_his ADD COLUMN beforeDays INT (11) DEFAULT 15 NULL COMMENT '提前还账单天数' AFTER canLoan;