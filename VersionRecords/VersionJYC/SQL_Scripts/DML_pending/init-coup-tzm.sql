...
INSERT  INTO `flat_roompricedtl`(`priceId`,`billType`,`billDtlType`,`amount`) SELECT LAST_INSERT_ID(),1009,1009,'300.00';
...
INSERT  INTO `flat_roompricedtl`(`priceId`,`billType`,`billDtlType`,`amount`) SELECT LAST_INSERT_ID(),1009,1009,'400.00';
...
INSERT  INTO `flat_roompricedtl`(`priceId`,`billType`,`billDtlType`,`amount`) SELECT LAST_INSERT_ID(),1009,1009,'800.00';
...
INSERT  INTO `flat_roompricedtl`(`priceId`,`billType`,`billDtlType`,`amount`) SELECT LAST_INSERT_ID(),1009,1009,'900.00';
...
INSERT  INTO `flat_roompricedtl`(`priceId`,`billType`,`billDtlType`,`amount`) SELECT LAST_INSERT_ID(),1009,1009,'1000.00';
...
INSERT  INTO `flat_roompricedtl`(`priceId`,`billType`,`billDtlType`,`amount`) SELECT LAST_INSERT_ID(),1009,1009,'1100.00';
