...
INSERT INTO comm_sysconfig(keyname,val,groupname,NAME,remark,updatetime,updatebytype,updateby) VALUES('FD-Acct-Login-001',1,'riskRule','定时器风险规则','val=1(启用)val=0(关闭)',NOW(),6,1);
