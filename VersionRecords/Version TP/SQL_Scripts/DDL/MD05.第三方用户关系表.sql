...
CREATE TABLE `user_third_account` (
  ...
  `cardType` varchar(32) DEFAULT NULL COMMENT '证件类型,参考字典表groupName=credential',
  `cardNo` varchar(32) DEFAULT NULL COMMENT '证件号码',
  `sex` tinyint(1) DEFAULT NULL COMMENT '性别(0:未知,1:男 ,2:女)',
  `constellation` varchar(32) DEFAULT NULL COMMENT '星座,参考字典表groupName=constellation',
  `hobby` varchar(255) DEFAULT NULL COMMENT '兴趣爱好',
  `career` varchar(255) DEFAULT NULL COMMENT '职业',
  `channel` int(10) DEFAULT NULL COMMENT '信息来源渠道,参考字典表groupName=channel',
  ...
  `createByType` int(11) DEFAULT NULL COMMENT '创建人类型,参考字典表groupName=userType',
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间',
  `updateBy` int(11) DEFAULT NULL COMMENT '更新人',
  `updateByType` int(11) DEFAULT NULL COMMENT '更新人类型,参考字典表groupName=userType',
  PRIMARY KEY (`id`),
  KEY `openId` (`openId`),
