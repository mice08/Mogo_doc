...
USE mogoroomdb;
DROP TABLE IF EXISTS traffic_commuting;

/*==============================================================*/
/* Table: traffic_commuting                                   */
/*==============================================================*/
CREATE TABLE traffic_commuting (
  `id`                      INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `origin_lng`              DECIMAL(3,3) DEFAULT NULL COMMENT '起点经度',
  `origin_lat`              DECIMAL(3,3) DEFAULT NULL COMMENT '起点纬度',
  `destination_lng`         DECIMAL(3,3) DEFAULT NULL COMMENT '终点经度',
  `destination_lat`         DECIMAL(3,3) DEFAULT NULL COMMENT '终点纬度',
