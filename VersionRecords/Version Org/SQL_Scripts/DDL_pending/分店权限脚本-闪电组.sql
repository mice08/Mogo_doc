...
drop table if exists perm_org_mesg;

/*==============================================================*/
/* Table: perm_org_mesg                                         */
/*==============================================================*/
create table perm_org_mesg
(
...
alter table perm_org_mesg comment '分店消息设置表';
...
ALTER TABLE  perm_menu_group   
  ...
  ADD COLUMN code VARCHAR(7) NULL  COMMENT '编码',
  ADD COLUMN channel INT(2) NOT NULL  COMMENT '频道来源(参考groupName=channel)',
  ADD COLUMN level int(2) NULL COMMENT '菜单分组层级';
