...
ALTER TABLE user_info ADD COLUMN companTel varchar(50) DEFAULT NULL COMMENT '公司电话';
...
ALTER TABLE user_info_his ADD COLUMN companTel varchar(50) DEFAULT NULL COMMENT '公司电话';
