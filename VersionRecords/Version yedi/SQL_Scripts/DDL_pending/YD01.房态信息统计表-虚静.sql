...
(
   ...
   building             varchar(16) default NULL comment '几栋',
   unit                 varchar(16) default NULL comment '几单元',
   floorNum             int(11) default NULL comment '第几层',
   flatsRoomNum         varchar(16) default NULL comment '几室',
   ...
   roomNum              varchar(16) default NULL comment '房源编号',
   roomName             varchar(16) default NULL comment '房间名、如A、B',
...
(
   ...
   renterName           varchar(32) default NULL comment '承租人名',
   ...
   hostName             varchar(16) default NULL comment '业主名',
   hostRentEndDate      date default NULL comment '业主到期日期',
   orgName              varchar(32) default NULL comment '分店名称',
