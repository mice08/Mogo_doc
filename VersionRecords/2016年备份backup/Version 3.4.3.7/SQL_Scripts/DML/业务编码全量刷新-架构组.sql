...
delete from `comm_busitype` where busiType in (60102002);
delete from `comm_busitype` where busiType in (60102003);
delete from `comm_busitype` where busiType in (60102004);
delete from `comm_busitype` where busiType in (60102005);
...
INSERT INTO `comm_busitype`(busiType,busiName,status,sort,level,isLeaf,parentId) VALUES(60102002,'房东登陆',1,1,3,1,60102);
INSERT INTO `comm_busitype`(busiType,busiName,status,sort,level,isLeaf,parentId) VALUES(60102003,'房东修改登陆密码',1,1,3,1,60102);
INSERT INTO `comm_busitype`(busiType,busiName,status,sort,level,isLeaf,parentId) VALUES(60102004,'房东修改联系手机',1,1,3,1,60102);
INSERT INTO `comm_busitype`(busiType,busiName,status,sort,level,isLeaf,parentId) VALUES(60102005,'查询房东信息',1,1,3,1,60102);
INSERT INTO `comm_busitype`(busiType,busiName,status,sort,level,isLeaf,parentId) VALUES(60103001,'修改个人信息',1,1,3,1,70101);
