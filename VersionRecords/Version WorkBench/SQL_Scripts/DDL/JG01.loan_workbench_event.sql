...
ADD COLUMN `financeServicer`  int(11) NULL COMMENT '金融服务人id (user_employee表Id)' AFTER `landlordSource`;

ALTER TABLE `user_landlord_info_his`
ADD COLUMN `financeServicer`  int(11) NULL COMMENT '金融服务人id (user_employee表Id)' AFTER `legalRepresentative`;
...
CREATE TABLE `loan_workbench_task` (
  ...
  `transferType`  varchar(20) NULL COMMENT '任务转移类型(1:休假 2:房东编辑)',
