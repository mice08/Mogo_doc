...
drop table if exists acct_refund_applepay;

/*==============================================================*/
/* Table: acct_refund_applepay                                  */
/*==============================================================*/
create table acct_refund_applepay
(
   id                   int(11) not null comment 'apple pay退款记录id',
   ...
   dt_refund            varchar(14) comment '商户退款时间',
   money_refund         varchar(10) comment '退款金额',
   ...
   primary key (id)
) ENGINE=InnoDB COMMENT='Applel pay退款记录表';
