...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,3,'房源审核通知','您的房源已经发布成功！蘑菇租房会对您所提交的房源信息进行审核，若您所提交的房源信息不真实、不准确，蘑菇租房核实后会下线该房源并一律按“假房源”进行处罚！',1,1,null,''
FROM dual WHERE exists (select id from mesg_templet where templetCode = 'sms_flats_verifyHint_landlord')
and not exists (select id from mesg_subtemplet where templetId=@mesgTempletId and templetType=3);
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','尊敬的${landlordName}您好，您有1笔总金额为${actualAmount}元的收款，来自租客${renterName}（${roomInfo}）申请的${period}月期蘑菇宝，已扣除手续费${feeAmount}元，保证金${depositAmount}元。',1,1,null,''
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','[租金宝]您的租金宝申请已审核通过，可办理后续业务。蘑菇租房400-800-4949',1,1,null,''
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','[蘑菇宝已通过]您的租客${renterName}，对应房源${roomInfo}，蘑菇宝申请已通过审批，等待放款中，请知悉。蘑菇租房400-800-4949',1,1,null,''
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','尊敬的${landlordName}您好，租客${renterName}（${roomInfo}）申请的蘑菇宝业务审核未通过。',1,1,null,''
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','[蘑菇宝首次申请不通过]您的租客${renterName}，对应房源${roomInfo}，蘑菇宝首次申请审批失败，请协助通知租客及时提交修改资料。蘑菇租房400-800-4949',1,1,null,''
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','[蘑菇宝审批不通过]您的租客${renterName}，对应房源${roomInfo}，蘑菇宝申请失败，此单将无再提供租金宝，请您与租客协商变更付款方式重新签约。蘑菇租房400-800-4949',1,1,null,''
...
INSERT INTO `mesg_subtemplet`
( `templetId`, `templetType`, `templetTitle`, `templetContent`, `status`, `valid`, `outTempletId`, `jumpCode`)
SELECT @mesgTempletId,1,'短信','尊敬的${landlordName}您好，租客${renterName}（${roomInfo}）申请的蘑菇宝业务已审核通过。',1,1,null,''
