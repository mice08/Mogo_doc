/* Database name `mogoroomdb`, 400新系统相关表创建 */
...
(
   ...
   `retunTime`        DATETIME comment '收回时间',
   ...
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='分机号表';
...
(
   ...
   `remark`        VARCHAR(255) comment '备注',
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='400导航表';
...
(
   ...
   `seatType`        VARCHAR(10) not null default '1' comment '坐席类型(0为外呼坐席，1为接听坐席，01两者皆是，01中间以英文逗号分隔)',
   ...
   `remark`        VARCHAR(255) comment '备注',
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='400坐席表';
...
(
   ...
   `remark`        VARCHAR(255) comment '备注',
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='分机用户关系表';
...
(
   ...
   `remark`        VARCHAR(255) comment '备注',
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='分机价格表';
...
(
   ...
   `cntctName`        VARCHAR(50) comment '绑定姓名',
   ...
   `remark`        VARCHAR(255) comment '备注',
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='400拨打记录表';
...
(
   ...
   `remark`        VARCHAR(255) comment '备注',
   primary key (id)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COMMENT='通话记录第三方信息表';
