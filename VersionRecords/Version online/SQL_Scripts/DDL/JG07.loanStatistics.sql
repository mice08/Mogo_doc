...
/*金融贷款申请统计信息表，预估表容量未来3个月1200行、读取量最多300行、无查询主要展示用*/
...
/*金融贷款放款统计信息表，预估表容量未来3个月1200行、读取量最多300行、无查询主要展示用*/
...
/*金融贷款还款统计信息表，预估表容量未来3个月3600行、读取量最多300行、无查询主要展示用*/
...
/*金融贷款买回统计信息表，预估表容量未来3个月200行、读取量最多300行、无查询主要展示用*/
