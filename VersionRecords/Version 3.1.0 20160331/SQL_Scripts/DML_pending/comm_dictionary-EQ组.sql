...
INSERT INTO `comm_dictionary` (`code`, `groupName`, `sort`, `keyPro`, `value`) VALUES ('denglu.png', 'msgico', '1', '11', '登录'); 
INSERT INTO `comm_dictionary` (`code`, `groupName`, `sort`, `keyPro`, `value`) VALUES ('tousu.png', 'msgico', '1', '12', '投诉'); 
INSERT INTO `comm_dictionary` (`code`, `groupName`, `sort`, `keyPro`, `value`) VALUES ('zufang.png', 'msgico', '1', '13', '租房'); 
INSERT INTO `comm_dictionary` (`code`, `groupName`, `sort`, `keyPro`, `value`) VALUES ('zuke.png', 'msgico', '1', '14', '欢迎租客'); 
