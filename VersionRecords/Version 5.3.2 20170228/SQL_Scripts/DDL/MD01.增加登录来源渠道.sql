...
/*初始化登录记录渠道类型类型*/
update user_loginlog set loginSource = 102 where terminalType = '1' and loginType  in (0,7) and LENGTH(terminalId) = 36 and loginSource is null ;
update user_loginlog set loginSource = 101 where terminalType = '1' and loginType  in (0,7) and LENGTH(terminalId) != 36 and loginSource is null;
update user_loginlog set loginSource = 101 where terminalType = '1' and loginType  in (0,7) and terminalId is null and loginSource is null;

update user_loginlog set loginSource = 102 where terminalType not in ('1','2','3','4') and loginType  in (0,7) and LENGTH(terminalId) = 36 and loginSource is null;
update user_loginlog set loginSource = 101 where terminalType not in ('1','2','3','4') and loginType  in (0,7) and LENGTH(terminalId) != 36 and loginSource is null;

update user_loginlog set loginSource = 105 where terminalType = '1' and loginType  = 4 and terminalId like 'platform=And%' and loginSource is null;
update user_loginlog set loginSource = 106 where terminalType = '1' and loginType  = 4 and terminalId like 'platform=iOS%' and loginSource is null;
update user_loginlog set loginSource = 105 where terminalType = '1' and loginType  = 4 and terminalId is null and loginSource is null;

update user_loginlog set loginSource = 201 where terminalType = '2' and loginType  in (0,7) and loginSource is null;
update user_loginlog set loginSource = 202 where terminalType = '2' and loginType  = 4 and loginSource is null;

update user_loginlog set loginSource = 301 where terminalType = '3' and loginSource is null;
update user_loginlog set loginSource = 401 where terminalType = '4' and loginSource is null;
