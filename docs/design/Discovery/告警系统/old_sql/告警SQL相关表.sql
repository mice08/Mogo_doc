...
-- ----------------------------
DROP TABLE IF EXISTS `supp_userWarnRelation`;
...
-- ----------------------------
DROP TABLE IF EXISTS `supp_warnTypeRelation`;
...
-- ----------------------------
DROP TABLE IF EXISTS `supp_warnType`;
...
-- ----------------------------
DROP TABLE IF EXISTS `supp_warnDetail`;
...
-- ----------------------------
DROP TABLE IF EXISTS `supp_warnAction`;
...
-- ----------------------------
DROP TABLE IF EXISTS `supp_warn`;
